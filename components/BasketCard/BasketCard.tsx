	...
	return (
		<div className='w-full h-[89px] flex justify-between relative  items-center'>
			...
			<div className='ml-[7px]'>
				...
				<span className="text-zinc-400 text-xs font-normal NunitoFont">{basket.weight}г</span>	
				<p  className="text-black text-xs font-normal NunitoFont">{basket.price}₽</p>
			</div>
			<button type="button" onClick={() => dispatch(DeleteProduct(basket.id))} className="bg-none rounded-md absolute right-0 top-1 p-2 inline-flex items-center justify-center text-black">
              <span className="sr-only">Close menu</span>
              <svg  width={15} height={15} xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" aria-hidden="true">
